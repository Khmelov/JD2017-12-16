...
public class Test_jd01_10 {
    ...
    public void testTaskB1__PrintMath() throws Exception {
        ...
        run("")
                ...
                .include("public static long multiplyExact(long,int)")
                ...
                .include("public static float fma(float,float,float)")
                .include("public static double fma(double,double,double)")
