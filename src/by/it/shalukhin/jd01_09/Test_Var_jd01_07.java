...
public class Test_Var_jd01_07 {

    @Test(timeout = 1500)
    public void testTaskA1_double__Scalar() throws Exception {
        Test_Var_jd01_07 ok=run("",false);
    ...
    private static Test_Var_jd01_07 run(String in) {
        return run(in, true);
    }

    private static Test_Var_jd01_07 run(String in, boolean runMain) {
        ...
        System.out.println("---------------------------------------------");
        return new Test_Var_jd01_07(clName, in, runMain);
    }

    public Test_Var_jd01_07() {
        //Конструктор тестов
    }
    ...
    private Test_Var_jd01_07(String className, String in, boolean runMain) {
